...
/*credits to cgcai from gitgub for the math regarding convertion from WGS84 to SVY21
 * i just used and amended certain portions to fit our project*/
...
private static final double radRatio = Math.PI / 180;		// Ratio to convert degrees to radians.
	 ...
	 */
	public static SVY21Coordinate executecomputeSVY21(double lat_, double long_) {
		return computeSVY21(lat_, long_);
	}
	 ...
	 */
	public static LatLonCoordinate executecomputeLatLon(double northing, double easting) {
